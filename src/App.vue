  ...
  <v-app>
    ...
    <template v-if="state === 'content'">
      ...
      <v-app-bar>
        ...
        <template #append>
          <span v-if="currentUser" class="mr-2 text-body-2">
            {{ currentUser.display_name || currentUser.preferred_username || currentUser._id }}
          </span>
    ...
    <!-- Authentication wall -->
    <v-main v-else>
      <v-container fluid fill-height class="d-flex align-center justify-center" style="min-height: 100vh;">
        <v-col cols="12" sm="6" md="4" lg="3">
          <div class="text-center mb-8">
            <div class="text-h5">Group manager</div>
          </div>

          <div v-if="['initial', 'loading'].includes(state)" class="text-center">
          ...
          <v-form v-if="state === 'login'" @submit.prevent="login">
            ...
            <v-alert v-if="loginError" color="error" class="mt-4">{{ loginError }}</v-alert>
            <div
              v-if="loginHint"
